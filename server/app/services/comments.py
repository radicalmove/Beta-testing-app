...
from app.models import Comment, CommentCategory, CommentStatus, CommentStatusEvent, PageLocation, User, UserRole
...
def create_comment(db: DbSession, author: User, *, course_id: uuid.UUID, page_url: str, body: str, category: str, selected_quote: str | None = None, prefix: str | None = None, suffix: str | None = None, css_selector: str | None = None, dom_selector: str | None = None, relative_x: float | None = None, relative_y: float | None = None) -> Comment:
    if not body.strip():
    ...
    instant = utc_now()
    location = PageLocation(course_id=course_id, page_url=page_url, selected_quote=selected_quote, prefix=prefix, suffix=suffix, css_selector=css_selector, dom_selector=dom_selector, relative_x=relative_x, relative_y=relative_y, created_at=instant)
    db.add(location)
    db.flush()
