...
export const semanticFilterHoverStyles = `.comment-filters .comment-scope:hover{background:var(--review-scope);border-color:var(--review-scope);color:#fff}.comment-filters .comment-status:hover{background:var(--review-status);border-color:var(--review-status);color:#fff}.comment-filters .comment-scope[aria-pressed="true"]:hover{background:#fff;border-color:var(--review-scope);color:var(--review-scope)}.comment-filters .comment-status[aria-pressed="true"]:hover{background:#fff;border-color:var(--review-status);color:var(--review-status)}.comment-jump[aria-expanded="true"]{background:var(--review-jump);border-color:var(--review-jump);color:#fff}.comment-page-field .comment-jump[aria-expanded="true"]:hover{background:#fff;border-color:var(--review-jump);color:var(--review-jump)}.toolbar-actions [data-action="add-comment"]{background:#fff;border-color:var(--review-dark-teal);color:var(--review-dark-teal)}.toolbar-actions [data-action="add-comment"]:hover{background:var(--review-dark-teal);border-color:var(--review-dark-teal);color:#fff}.toolbar-actions [data-action="add-comment"][aria-pressed="true"]{background:var(--review-red);border-color:var(--review-red);color:#fff}.toolbar-actions [data-action="add-comment"][aria-pressed="true"]:hover{background:#fff;border-color:var(--review-red);color:var(--review-red)}.comment-row-action.delete-action{border-radius:5px}`;
...
export function mountReviewOverlay(document: Document, context: CourseContext, status: ConnectionStatus = "connecting", options: ReviewOverlayOptions = {}, buildDiagnostics: BuildDiagnostics = defaultBuildDiagnostics): ReviewOverlay {
  ...
  style.textContent += commentListLayoutStyles + approvedControlStyles + controlAlignmentStyles + semanticFilterHoverStyles;
  shadow.append(style);
